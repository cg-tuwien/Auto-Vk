...
namespace ak
{
	...
	struct renderpass_sync
	{
		...
		renderpass_sync(int aSrcPass, int aDstPass, ak::pipeline_stage aSrcStage, std::optional<ak::write_memory_access> aSrcAccess, ak::pipeline_stage aDstStage, std::optional<ak::memory_access> aDstAccess)
		 ...
		 */
		std::optional<ak::memory_access> mDestinationMemoryDependency;
