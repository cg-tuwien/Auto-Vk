...
namespace avk
{
	...
	public:
		...
		{
			return shader_binding_table_ref{ shader_binding_table_handle(), shader_binding_table_device_address(), table_entry_size(), std::cref(shader_binding_table_groups()), mDynamicDispatch };
		}
