...
namespace ak
{
	...
	vk::AttachmentLoadOp to_vk_load_op(xv::on_load aValue)
	{
		switch (aValue) {
		case xv::on_load::dont_care:
			return vk::AttachmentLoadOp::eDontCare;
		case xv::on_load::clear: 
			return vk::AttachmentLoadOp::eClear;
		case xv::on_load::load: 
	...
	vk::AttachmentStoreOp to_vk_store_op(xv::on_store aValue)
	{
		switch (aValue) {
		case xv::on_store::dont_care:
			return vk::AttachmentStoreOp::eDontCare;
		case xv::on_store::store:
		case xv::on_store::store_in_presentable_format:
